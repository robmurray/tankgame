...
*/
	...
	function onkey(ev, key, pressed){
		...
		switch(kc) {
      		case KEY_CODE.LEFT:  
      			playerTank.input.left = pressed;
				ev.preventDefault();
      			break;
      		case KEY_CODE.RIGHT: 
      			playerTank.input.right = pressed; 
      			ev.preventDefault(); 
      			break;
      		case KEY_CODE.UP: 
      			playerTank.input.up = pressed; 
      			ev.preventDefault(); 
      			break;
      		case KEY_CODE.DOWN: 
      			playerTank.input.down = pressed; 
      			ev.preventDefault(); 
      			break;
	...
	function update(param) {
	    ...
	    else if (playerTank.input.right) {
